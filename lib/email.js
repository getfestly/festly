...
const VEHICLE_HINTS = {
  ...
  lkw_mittel:    'Anlieferungshinweis: Das Angebot wird per LKW (bis 7,5t) angeliefert. Bitte stellen Sie sicher, dass die Zufahrt für LKW befahrbar, das Gelände tragfähig und ausreichend Rangierplatz vorhanden ist.',
  lkw_gross:     'Anlieferungshinweis: Das Angebot wird per LKW mit Kran angeliefert. Bitte stellen Sie sicher, dass: die Zufahrt für Schwerlastfahrzeuge befahrbar ist, der Kranstandplatz verdichtet und tragfähig ist, ausreichend Rangier- und Aufbaufläche vorhanden ist und keine Hindernisse (Leitungen, Bäume, Bauten) den Kranbereich einschränken.',
}
